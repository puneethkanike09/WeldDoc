...
export function DiscardWpqButton({
  action,
}: {
  action: () => Promise<void>;
}) {
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            It will be removed from the welder profile and master list. Any
            saved test data and uploaded reports for this draft will be deleted.
