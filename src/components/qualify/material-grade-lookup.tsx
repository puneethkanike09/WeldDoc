...
export function MaterialGradeLookup({
  ...
  const emitValues = (
    ...
    onValuesChange?.({ lookupSource: source, standard: std, grade: gr, group: grp });
  };

  useEffect(() => {
    emitValues(lookupSource, standard, grade, parentGroup);
  }, [lookupSource, standard, grade, parentGroup]);
