...
export const GEO_ONE_LINER =
  "Weld.Doc is welder qualification software — certificates, WPQ/WPQR records, welder continuity tracking, QR verification, and expiry alerts. Available now for ISO 9606-1 and ISO 14732; ASME Section IX and AWS D1.1 on the roadmap.";

export const GEO_DEFINITION = `${SITE_NAME} is cloud software for managing welder and welding operator qualifications. It helps fabrication shops and quality teams register people, run qualification workflows, generate compliant certificates, track continuity and revalidation dates, and verify status on site with a QR code — without needing a full welding ERP.`;
